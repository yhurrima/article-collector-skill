...
刷到好文章但没时间读？收藏夹总吃灰？
这个工具帮你一键把文章存进飞书，生成内容总结，等你不忙时再用飞书消息发给你，还支持定时发送。让你的收藏变成订阅，不再吃灰。

## 功能亮点

- **一键收藏，不用打断阅读节奏** — 浏览网页时点击插件，文章自动存入飞书多维表格，标题、作者、来源、分类全部自动填充
- **AI 帮你读完再告诉你值不值得读** — 自动提取摘要和主要观点，快速判断一篇文章是否值得深读
- **定时推送阅读汇总** — 每天定时收到飞书消息，包含今日收藏的文章概览和汇总文档，适合通勤或睡前快速回顾
- **阅读统计仪表盘** — 分类饼图、来源柱状图、每日收藏趋势，一眼看清你的阅读习惯和关注方向
- **支持时间筛选** — 查看任意时间段的阅读统计，比如"这个月我都读了什么"
